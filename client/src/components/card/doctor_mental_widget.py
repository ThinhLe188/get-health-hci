...
class DoctorMentalInfoWidget(QWidget):
    def __init__(self, gender, name, expertise, years_of_service, clinic_name, appointment_type, distance, parent=None):
        super(DoctorMentalInfoWidget, self).__init__(parent)
        ...
        self.image_label.setStyleSheet("border-radius: 50px; border: 2px solid #8E44AD;")  # Circular profile picture
        ...
        # Expertise
        self.expertise_label = QLabel(f"🩺 Expertise: {expertise}")
        self.expertise_label.setStyleSheet("color: #34495E; font-size: 12px;")

        # Years of service
        self.years_label = QLabel(f"📅 Experience: {years_of_service}")
        ...
        info_layout.addWidget(self.expertise_label)
