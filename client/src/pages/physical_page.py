...
from components.card.doctor_physical_widget import DoctorPhysicalInfoWidget
...
class PhysicalPage(ContentWidget):
    ...
    def _init_content_section(self):
        ...
        label_professionals = QLabel('Connect with physical health specialists')
    ...
    def _load_doctor(self):
        for data in const.PHYSICAL_DOC:
            item = QListWidgetItem()
            widget = DoctorPhysicalInfoWidget(*data)
